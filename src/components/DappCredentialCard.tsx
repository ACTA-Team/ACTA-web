...
export default function DappCredentialCard({
  ...
  const disclaimerSize = isMobile
    ? `12px`
    : `clamp(10px, ${12 * scale}px, 14px)`;
  ...
  return (
    <div
      className="relative mx-auto rounded-2xl w-full"
        ...
        >
          ...
          <div className="relative h-full w-full grid grid-cols-1 md:grid-cols-12 gap-4 p-4 md:p-6">
            ...
            <div className="md:col-span-7 flex flex-col">
              ...
              <div
                className="mt-5 space-y-3 font-serif"
                style={{ fontSize: detailsSize, lineHeight: 1.45 }}
              >
                <p>
                  <span className="text-white/80">Holder:</span> {front.holder}
                </p>
                <p>
                ...
                <p>
                  <span className="text-white/80">Issued on:</span>{" "}
                  {front.issuedOn}
                </p>
                <p>
              ...
              <div className="mt-auto pt-4 hidden md:flex items-center">
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center justify-center h-5 w-5 rounded-full border border-white/20 bg-white/10">
                    ✓
                  </span>
            ...
            <p
              className="hidden md:block absolute bottom-4 right-6 text-right italic text-white/80"
